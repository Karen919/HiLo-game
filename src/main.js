...
export default function Main() {
  ...
  async function consCards() {
    ...
    const consoleOutput = consoleArr.reverse().slice(0,consoleArr.length/2)
    ...
    <div className="main">
      <div className="contein_main">
        ...
        <section className="section_x12">
          ...
          <div>
            <span className="x12 onClick" id='two'>2</span>
            <span className="x12 onClick" id="tre">3</span>
            <span className="x12 onClick" id="four">4</span>
            <span className="x12 onClick">5</span>
            <span className="x12 onClick">6</span>
            <span className="x12 onClick">7</span>
            <span className="x12 onClick">8</span>
            <span className="x12 onClick">9</span>
            <span className="x12 onClick">J</span>
            <span className="x12 onClick">Q</span>
            <span className="x12 onClick">K</span>
            <span className="x12 onClick">A</span>
          </div>
        </section>
        <div className="section_contein">
        <section className="section_left">
          <div className="section_left_intro onClick"><span>2-9</span><span className="x">x1.5</span></div>
          <div className="section_left_intro onClick" ><span>JQKA</span><span className="x">X3</span></div>
          <div className="section_left_intro onClick" ><span>KA</span><span className="x">x6</span></div>
          <div className="section_left_intro onClick"><span>A</span><span className="x">x12</span></div>
          <div className="section_left_intro xred onClick"><span>Կարմիր</span><span className="x">x2</span></div>
          <div className="section_left_intro xblack onClick"><span>Սև</span><span className="x">x2</span></div>
        </section>
